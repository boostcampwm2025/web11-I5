...
주인님, 각 항목을 한 줄 중심으로 압축했습니다.

1. **구두 설명 기반 학습**
   말이나 글로 설명하는 과정 자체를 학습으로 삼아 지식을 정리합니다.

2. **AI 정량 평가 및 피드백**
   답변을 모범 답안과 비교해 정확도·논리·깊이를 점수와 피드백으로 제공합니다.

3. **지식 구조화 및 시각화**
   개념과 키워드 간 관계를 그래프로 시각화해 구조적으로 이해합니다.

4. **지속 학습 게이미피케이션**
   스트릭과 점수로 학습 동기를 유지하고 루틴화를 돕습니다.
