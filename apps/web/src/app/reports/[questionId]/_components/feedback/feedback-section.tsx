    ...
    return (
      <section className="p-5 md:p-9 transition-all duration-300">
        <div className="flex flex-col items-center justify-center py-8 md:py-12 gap-4 md:gap-6">
          <div className="w-12 h-12 md:w-14 md:h-14 border-4 border-[#4FD1C5] border-t-transparent rounded-full animate-spin" />
      ...
      <section className="p-5 md:p-9 transition-all duration-300">
        <div className="flex flex-col items-center justify-center py-8 md:py-12 gap-4 md:gap-6">
          ...
          {isSttFailed ? (
            <RetryButton
              question={question}
              className="flex cursor-pointer items-center gap-2.5 bg-teal-400 hover:bg-teal-500 text-white font-bold px-3 md:px-4 py-2 md:py-2.5 rounded-xl transition-colors text-sm md:text-base"
            />
          ) : (
            <ReEvaluateButton
