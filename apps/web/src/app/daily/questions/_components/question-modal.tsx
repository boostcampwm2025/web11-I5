      ...
      >
        <div className="p-5 sm:p-6 md:p-8">
          ...
          <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
            <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md bg-gray-100 text-gray-500 text-xs sm:text-sm font-medium">
              {question.category?.name}
            </span>
            {/* 중요도 숫자 표기 */}
            <span className="px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg bg-yellow-50 text-yellow-600 text-xs font-bold flex items-center gap-1">
          ...
          {answerMode === "voice" && (
            <div className="mb-4 sm:mb-6 animate-in fade-in zoom-in-95 duration-300">
              <MicrophoneTester />
            </div>
          )}
          ...
          <div className="flex gap-2 sm:gap-3">
            <Button
              ...
              size="lg"
              onClick={onClose}
              className="flex-1 font-semibold border-gray-200 text-gray-600 hover:bg-gray-50 text-sm sm:text-base py-2.5 sm:py-3"
            >
              닫기
            </Button>
            <Button
              ...
              variant="default"
              size="lg"
              className="flex-1 font-semibold text-sm sm:text-base py-2.5 sm:py-3"
            >
