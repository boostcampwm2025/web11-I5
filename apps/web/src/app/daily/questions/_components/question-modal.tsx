    ...
    >
      ...
      >
        <div className="p-8">
          ...
          {answerMode === "text" && (
            <div className=" h-75 mb-6 w-full bg-slate-50 border border-slate-100 rounded-2xl p-8 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-300">
